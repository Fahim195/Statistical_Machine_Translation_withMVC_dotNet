...
namespace SMTwebVersion.Models.Ambiguity
{
    public class AmbiguitySolution
    {
        ...
        {
            string rule = "";
              if ((objects[prepositionIndex + 1] == "a" || objects[prepositionIndex + 1] == "an" || objects[prepositionIndex + 1] == "the") /*DT=article*/ && (object_postags[prepositionIndex + 2] == "NN " || object_postags[prepositionIndex + 2] == "NNS " || object_postags[prepositionIndex + 2] == "NNP " || object_postags[prepositionIndex + 2] == "NNPS " || object_postags[prepositionIndex + 2] == "PRP " || object_postags[prepositionIndex + 2] == "PRP$ "))
            {
